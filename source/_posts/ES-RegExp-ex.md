...
![하지만 이는 자바스크립트에서 지원하지 않는다.](05.png)  
...
![you란 단어 뒤에 I란 단어가 나오는 문장](07.png)  
![(?=)을 사용하면 이렇게도 바꿀 수 있다.](09.png)  
...
```
![순서가 상관 없다면 or 연산자를 사용하여 쓸 수 있다.](08.png)  
![(?=)을 사용하면 이렇게도 바꿀 수 있다.](10.png)  
