...
참고로 이 책은 `새로운 것을 창조하는 회사를 만드는 방법`을 다루는 책임.  
...
근데 우리가 이런 것들을 배웠음에도 불구하고 자주 까먹는는 이유(애초에 이런 걸 생각조차 하지 못하는 이유)는 `대부분 했던 일을 반복하는 세상`속에서 우리가 살고 있기 때문이다.
```text
...
여기서 X라고 믿는 사람이 많이 없어야하며, 진실은 Y라고 믿는 사람도 많지 않아야 좋은 대답이라고 할 수 있다고 한다.
대부분의 사람이 X라고 믿는 이유는 `학교에서 배우는 지식은 모든 사람들이 동의한 내용`이기 때문이고,
내가 정반대라고 믿는 이유는 `미래를 예견`했기 때문이다. (물론 정확하지 않을 수 있겠지만...?)  
...
2. 수직적 진보(집중적 진보): 해로운 일을 하는 것(0 -> 1), 아무도 한 적이 없는 일을 하는 것이기 때문에 미래가 쉽게 상상되지 않는다.
...
외부에서 바라봤을 때는 매출 규모라던지, 기업 가치라던지, 인원이라던지 이런 외형적으로 보이는 요소에만 집중할 수 밖에 없는데 그런 기준에서는 분명 대기업이 맞다.
