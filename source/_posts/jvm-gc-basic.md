...
이 글은 이일웅 님께서 번역하신 [자바 최적화](https://book.naver.com/bookdb/book_detail.nhn?bid=14796595)란 책을 읽고 공부한 내용을 정리한 글입니다.  
...
![이 때 Eden에서 복사되는 객체는 generational count가 1로 증가한다. (Stop the World의 끝)](minor-gc-13.png)
