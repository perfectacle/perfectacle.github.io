...
아태클을 보던 중에 후반 부분에 Mock과 관련해서 [Mock Roles, not Objects](http://jmock.org/oopsla2004.pdf)라는 논문까지 썼다는 걸 보고 해당 논문까지 봐야 Mock에 대해 정확한 이해를 할 수 있을 것 같아 해당 논문을 보게 되었다.
